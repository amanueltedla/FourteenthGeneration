...
class TelegramFeedListController extends MvcController {
  final int channelId;
  ...
  List<TelegramChannelMessageInfo> get messages => _messages.toList().reversed.toList();
  int get messagesCount => messages?.length ?? 0;

  TelegramFeedListController({@required this.channelId});

...
import 'feed_listview.controller.dart';


class TelegramFeedList extends MvcWidget<TelegramFeedListController> {
  final int channelId;
  ...
  @override
  TelegramFeedListController initController() =>
      TelegramFeedListController(channelId: channelId);
